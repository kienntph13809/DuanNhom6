    ...
    void FillTable() {
        ...
        for (KhachHang x : listKH) {
            model.addRow(new Object[]{
                x.getMakh(), x.getTenkh(),x.getSDT(), x.getDiaChi(),  x.isTrangThai()?"1":"0"
            });
        }
    }
    void reset(){
   ...
   void insert() {
        ...
        try { 
            ...
            if (txtMaKH.getText().trim().equals("")) {
                DialogHelper.alert(this, "Vui lòng không bỏ trông ô mã khách hàng");
                return;
      ...
      void setForm() {
        ...
        if (tblQuanLyKhacHang.getValueAt(row, 4).toString().equals(" Hoạt động")) {
            rdhoatdong.setSelected(true);
        } else {
    ...
    KhachHang getForm() {
        ...
        kh.setTrangThai(rdhoatdong.isSelected());
        return kh;
    }
    void update(){
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btninsert, btnsua, jButton7});
