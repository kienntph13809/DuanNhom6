...
public class formdanhmuc extends javax.swing.JInternalFrame {
    ...
    void filtable(){
        DefaultTableModel model=(DefaultTableModel) tbdm.getModel();
        model.setRowCount(0);
        List<DanhMuc> list=dmd.selectAll();
        for (DanhMuc x : list) {
            model.addRow(new Object[]{
            
            x.getMadm(),x.getTendm(),x.isTrangThai()?"1":"0"
    ...
    void insert(){
        ...
        try { 
            ...
            if (txtmadm.getText().trim().equals("")) {
                DialogHelper.alert(this, "Vui lòng không bỏ trông ô mã danh mục");
                return;
            } else if (txttendanhmuc.getText().trim().equals("")) {
                DialogHelper.alert(this, "Vui lòng không bỏ trông ô tên danh mục");
                return;
            }
            else if (checkTrung()) {
                DialogHelper.alert(this, "Mã danh mục  đã tồn tại");
                return;
            }  else {
                dmd.insertData(kh);
               filtable();
      ...
      void setForm() {
        txtmadm.setText(tbdm.getValueAt(row, 0) + "");
        txttendanhmuc.setText(tbdm.getValueAt(row, 1) + "");
       
       
        if (tbdm.getValueAt(row, 3).toString().equals(" còn hoạt động")) {
            rdhd.setSelected(true);
        } else {
            rdnghd.setSelected(false);
        }
    }
    ...
    private void initComponents() {
        ...
        rdnghd = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(rdnghd);
        rdnghd.setText("Ngừng Hoạt dộng");
  ...
  DanhMuc getForm() {
       ...
       dm.setTrangThai(rdhd.isSelected());
       return dm;
    }
  boolean checkTrung(){
        boolean check = false;
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).equals(Integer.parseInt(txtmadm.getText()))) {
                check = true;
                break;
            }
        }
    ...
    private javax.swing.JRadioButton rdnghd;
